...
//    private val preferredLocale: Locale = Locale.getDefault()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        resources.configuration.setLocale(Locale.CHINESE)
        ...
        GlobalScope.launch(Dispatchers.Main) {
            ...
            if (sunriseTime != null && sunsetTime != null) {
                ...
                binding.textViewSunrise.text =
                    "${getLocaleStringResource(preferredLocale, R.string.SunriseTime, applicationContext)} $localizedSunrise"
                binding.textViewSunset.text =
                    "${getLocaleStringResource(preferredLocale, R.string.SunsetTime, applicationContext)} $localizedSunset"
            }
        }
    }
    ...
    private fun getLocalizedTime(time: LocalDateTime, context: Context): String {
        ...
        val sdf = SimpleDateFormat("hh:mm a", Locale(preferredLocale.language))
